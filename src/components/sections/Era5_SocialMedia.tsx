...
export default function Era5_SocialMedia() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      // Reveal animations
      gsap.utils.toArray(".era5-reveal").forEach((elem: any) => {
        gsap.fromTo(
          elem,
    ...
    >
      ...
      <div className="w-full bg-paper text-ink pt-24 md:pt-32 pb-32 px-2 md:px-12 flex flex-col items-center border-x-[8px] md:border-x-[40px] border-paper relative overflow-hidden">
              ...
              <Tilt3D intensity={6}>
                <div className="w-full relative border-[4px] border-ink overflow-hidden group">
                  <img
                    ...
                    className="w-full min-h-[300px] md:min-h-[500px] object-cover contrast-110 group-hover:scale-105 transition-all duration-700"
                  />
        ...
        <div className="w-full max-w-7xl mx-auto border-t-[12px] border-ink mt-24 md:mt-32 mb-16 relative era5-reveal">
          <div className="absolute top-0 left-1/2 -translate-x-1/2 -translate-y-1/2 bg-paper px-8 text-ink font-sans font-black tracking-[0.5em] text-sm py-2 border-4 border-ink whitespace-nowrap">END OF VOL. 5</div>
        </div>
